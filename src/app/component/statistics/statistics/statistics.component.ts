...
export class StatisticsComponent implements OnInit {
  ...
  constructor(public statisticsService: StatisticsService, public storage: AngularFireStorage) { }
  ...
  onUpload(e){
    ...
    const filePath = `uploads/statistics/${id}`;
  ...
  onSubmit(statisticsForm: NgForm) {

    this.statisticsService.getStatistics();

    if (statisticsForm.value.$keyRegistro == null) {
      // this.statisticsService.insertStatistics(statisticsForm.value);
      // Swal.fire({
      //   position: 'center',
      //   type: 'success',
      ...
      this.statisticsService.updateStatistics(statisticsForm.value);
      Swal.fire({
        position: 'center',
        type: 'success',
